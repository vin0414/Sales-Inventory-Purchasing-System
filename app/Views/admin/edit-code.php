                        ...
                        <div id="kt_app_content_container" class="app-container container-fluid ">
                            <div class="card card-flush py-4">
                                <div class="card-header">
                                    <div class="card-title"><i class="fa-solid fa-layer-group"></i>&nbsp;<?=$title?></div>
                                </div>
                                <div class="card-body pt-0">
                                    <?php if($account): ?>
                                    <form method="POST" class="form w-100" action="<?=site_url('save-account-expense')?>" id="frmAccount">
                                        <input type="hidden" name="account_id" value="<?php echo $account['expenseID']?>"/>
                                        <div class="fv-row mb-4">
                                            <span class="menu-title">Account Code</span>
                                            <input type="text" class="form-control" name="account_code" value="<?php echo $account['accountCode']?>"/>
                                            <span class="text-danger"><?=isset($validation)? display_error($validation,'account_code') : '' ?></span>
                                        </div>
                                        <div class="fv-row mb-4">
                                            <span class="menu-title">Account Details</span>
                                            <textarea class="form-control" name="account_details" style="height:150px;"><?php echo $account['accountDetails']?></textarea>
                                            <span class="text-danger"><?=isset($validation)? display_error($validation,'account_details') : '' ?></span>
                                        </div>
                                        <div class="fv-row mb-4">
