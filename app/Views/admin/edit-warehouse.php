                            ...
                            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                        ...
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">
                                            <a href="<?=site_url('admin/settings')?>" class="text-muted text-hover-primary">
                                                Settings                           
                                            </a>                                      
                                        </li>
                                        <!--end::Item-->     
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <a href="<?=site_url('admin/settings')?>" class="btn btn-sm btn-flex btn-primary newEntry">
                        ...
                        <div id="kt_app_content_container" class="app-container container-fluid ">
                            <div class="card card-flush py-4">
                                <div class="card-header">
                                    <div class="card-title"><i class="fa-solid fa-warehouse"></i>&nbsp;<?=$title?></div>
                                </div>
                                <div class="card-body pt-0">
                                    <?php if($warehouse): ?>
                                    <form method="POST" class="form w-100" action="<?=site_url('save-warehouse')?>" id="frmWarehouse">
                                        <input type="hidden" name="id" value="<?php echo $warehouse['wID'] ?>"/>
                                        <div class="fv-row mb-4">
                                            <span class="menu-title">Name of Warehouse</span>
                                            <input type="text" class="form-control" name="warehouse" value="<?php echo $warehouse['w_Name'] ?>"/>
                                            <span class="text-danger"><?=isset($validation)? display_error($validation,'warehouse') : '' ?></span>
                                        </div>
                                        <div class="fv-row mb-4">
                                            <div class="row g-3">
                                                <div class="col-lg-6">
                                                    <span class="menu-title">Email</span>
                                                    <input type="email" class="form-control" name="email" value="<?php echo $warehouse['w_Email'] ?>"/>
                                                    <span class="text-danger"><?=isset($validation)? display_error($validation,'email') : '' ?></span>
                                                </div>
                                                <div class="col-lg-6">
                                                    <span class="menu-title">Contact No</span>
                                                    <input type="phone" class="form-control" name="phone" value="<?php echo $warehouse['w_Phone'] ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="11" minlength="11"/>
                                        ...
                                        <div class="fv-row mb-4">
                                            ...
                                            <textarea class="form-control" name="address" style="height:150px;"><?php echo $warehouse['w_Address'] ?></textarea>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-lg-1">
                                                    <div class="form-check form-check-custom form-check-success form-check-solid">
                                                        <?php if($warehouse['w_Status']==1 ){ ?>
                                                        <input class="form-check-input" type="radio" value="1" id="flexCheckboxSm" name="status" checked/>
                                                        <?php }else { ?>
                                                        <input class="form-check-input" type="radio" value="1" id="flexCheckboxSm" name="status"/>
                                                        <?php } ?>
                                                ...
                                                <div class="col-lg-1">
                                                    <div class="form-check form-check-custom form-check-danger form-check-solid">
                                                        <?php if($warehouse['w_Status']==0 ){ ?>
                                                        <input class="form-check-input" type="radio" value="0" id="flexCheckboxSm" name="status" checked/>
                                                        <?php }else { ?>
                                                        <input class="form-check-input" type="radio" value="0" id="flexCheckboxSm" name="status"/>
                                                        <?php } ?>
                                                        <label class="form-check-label" for="flexCheckboxSm">
                                                            Inactive
                                                        </label>
