                    ...
                    <div class="app-header-secondary-menu-main d-flex flex-grow-lg-1 align-items-end pt-3 pt-lg-2 px-3 px-lg-0 w-auto overflow-auto flex-nowrap">
                        <div class="app-container  container-fluid ">
                            ...
                            >        
                                ...
                                <!--begin:Menu item-->
                                <div  class="menu-item" ><!--begin:Menu link-->
                                    <a class="menu-link active"  href="<?=site_url('admin/products/new')?>"><span  class="menu-title" >New Product</span></a>
                                    <!--end:Menu link-->
                                </div><!--end:Menu item-->
                                <!--begin:Menu item-->
                                <div  class="menu-item" ><!--begin:Menu content-->
            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_content" class="app-content  flex-column-fluid " >
                    <div id="kt_app_content_container" class="app-container container-fluid ">
                        <form method="POST" action="<?=base_url('save-employee')?>" enctype="multipart/form-data" class="d-flex flex-column flex-lg-row gap-3 w-100" id="frmProduct">
                            <?= csrf_field(); ?>
                            <div class="col-12">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="card card-flush py-4">
                                            <div class="card-header">
                                                <div class="card-title"><h2>Product Image</h2></div>
                                            </div>
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <!--begin::Button-->
                                                <a href="<?=site_url('admin/products/new-category')?>" class="btn btn-light-primary form-control btn-sm mb-10">
                                                    <i class="fa-solid fa-plus-circle fs-2"></i>&nbsp;Create new category
                                                </a>
                                                <!--end::Button-->
                                            </div>
                                            <!--end::Card body-->
                                                ...
                                                <div class="mb-2 fv-row">
                                                    ...
                                                    <div class="dropzone" id="kt_ecommerce_add_product_media">
                                                        ...
                                                        <div class="dz-message needsclick">
                                                            <!--begin::Icon-->
                                                            <i class="fa-solid fa-upload text-primary fs-3x"></i>                    <!--end::Icon-->
                                                            <!--begin::Info-->
                                                            <div class="ms-4">
...
<!--end::App-->		
		...
		<!--begin::Global Javascript Bundle(mandatory for all pages)-->
                ...
                <script src="<?=base_url('assets/js/save-product.js')?>"></script>
                <script src="<?=base_url('assets/js/product.js')?>"></script>
			<!--end::Global Javascript Bundle-->

		<!--begin::Vendors Javascript(used for this page only)-->
				<script src="<?=base_url('assets/plugins/custom/datatables/datatables.bundle.js')?>"></script>
                <script src="<?=base_url('assets/plugins/custom/formrepeater.bundle.js')?>"></script>
