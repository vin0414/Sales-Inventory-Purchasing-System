                    ...
                    <div id="kt_app_content_container" class="app-container container-fluid ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card bg-primary rounded">
                                                    <i class="fa-solid fa-boxes-packing icon fs-1 text-white"></i>
                                                </div> 
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card card-flush">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card bg-primary rounded">
                                                    <i class="fa-solid fa-box icon fs-1 text-white"></i>
                                                </div> 
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card card-flush">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card bg-primary rounded">
                                                    <i class="fa-solid fa-box-open icon fs-1 text-white"></i>
                                                </div> 
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card card-flush">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card bg-primary rounded">
                                                    <i class="fa-solid fa-triangle-exclamation icon fs-1 text-white"></i>
                                                </div> 
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card card-flush py-4">
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                <div class="card-title">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <i class="fa-solid fa-magnifying-glass fs-1 position-absolute ms-4"></i>
                                        <input type="text" data-kt-filter="search" class="form-control form-control-solid w-300px ps-14" placeholder="Search" />
                                    </div>
                                    <!--end::Search-->
                                ...
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    <a class="btn btn-primary" href="<?=site_url('admin/products/new')?>">
                            ...
                            <div class="card-body pt-0">
                                <table class="table table-bordered table-striped align-middle" id="kt_datatable">
                                    <thead class="text-gray-500 fw-bold fs-7 text-uppercase">
                                        <th class="bg-primary text-white min-w-200px">Product Name</th>
                                        <th class="bg-primary text-white min-w-350px">Description</th>
                                        <th class="bg-primary text-white min-w-50px">UOM</th>
                                        <th class="bg-primary text-white min-w-50px">QTY</th>
                                        <th class="bg-primary text-white min-w-50px">RE-ORDER</th>
                                        <th class="bg-primary text-white min-w-100px">STATUS</th>
                                        <th class="bg-primary text-white min-w-30px">MORE</th>
                                    </thead>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Thumbnail-->
                                                    <a href="<?=site_url('admin/products/edit/')?><?php echo $row['productID'] ?>" class="symbol symbol-50px">
                                                        <span class="symbol-label" style="background-image:url(<?=base_url('products/')?><?php echo $row['Image'] ?>);"></span>
                                                    </a>
                                                    <!--end::Thumbnail-->

                                                    <div class="ms-5">
                                                        <!--begin::Title-->
                                                        <a href="<?=site_url('admin/products/edit/')?><?php echo $row['productID'] ?>" class="text-gray-800 text-hover-primary fw-bold"><?php echo $row['productName'] ?></a>
                                                        <!--end::Title-->
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="pe-0"><small><?php echo $row['productDescription'] ?></small></td>
                                            <td class="pe-0"><?php echo $row['UOM'] ?></td>
                                            <td class="pe-0"><?php echo $row['Qty'] ?></td>
                                            <td class="pe-0"><?php echo $row['ReOrder'] ?></td>
                                            <td class="pe-0">
                                                <?php if($row['Qty']>$row['ReOrder']){ ?>
                                            ...
                                            <td class="pe-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="<?=site_url('admin/products/view/')?><?php echo $row['productID'] ?>" class="menu-link px-3">
                                                            View Details
                                                        </a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="<?=site_url('admin/products/edit/')?><?php echo $row['productID'] ?>" class="menu-link px-3">
                                                            Edit Product
                                                        </a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="<?=site_url('admin/products/generate')?><?php echo $row['productID'] ?>" class="menu-link px-3">
                                                            Generate QR
                                                        </a>
                                                    </div>
                                                    <!--end::Menu item-->
            ...
            "use strict";
                ...
                var KTDatatablesExample = function () {
                    ...
                    var exportButtons = () => {
                        ...
                        }).container().appendTo($('#kt_datatable'));
