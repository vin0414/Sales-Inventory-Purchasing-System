                                ...
                                <div class="card-body pt-0">
                                    <form method="POST" class="form w-100" action="<?=site_url('save-warehouse')?>" id="frmWarehouse">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" class="form-control" name="warehouse" value="<?=set_value('warehouse')?>"/>
                                        ...
                                        <div class="fv-row mb-4">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="phone" class="form-control" name="phone" value="<?=set_value('phone')?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="11" minlength="11"/>
                                        ...
                                        <div class="fv-row mb-4">
                                            ...
                                            <textarea class="form-control" name="address" style="height:150px;"><?=set_value('address')?></textarea>
