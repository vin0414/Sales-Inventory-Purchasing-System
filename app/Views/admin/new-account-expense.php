                                ...
                                <div class="card-body pt-0">
                                    <form method="POST" class="form w-100" action="<?=site_url('save-account-expense')?>" id="frmAccount">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" class="form-control" name="account_code" value="<?=set_value('account_code')?>"/>
                                        ...
                                        <div class="fv-row mb-4">
                                            ...
                                            <textarea class="form-control" name="account_details" style="height:150px;"></textarea>
